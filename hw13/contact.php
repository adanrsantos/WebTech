    ...
    <div class="sidebar-navigation hidden-sm hidden-xs">
        ...
        <nav>
            <ul>
                ...
                <li>
                    <a href="#top" class="active-section">
                        <span class="rect"></span>
                        <span class="circle"></span>
                        Contact
                    </a>
        ...
        <section class="content-section main-container">
            ...
            <form action="results.php" method="get">
                <div class="section-content">
                    ...
                    ?>
                    <div id="fnGroup" class="form-group has-default">
                        <label class="control-label">First Name:</label>
                        <input type="text" id="firstName" name="firstName" class="form-control">
                        <span id="fnFeedBack" class="help-block"></span>
                    </div>
                    <div id="lnGroup" class="form-group has-default">
                        <label class="control-label">Last Name:</label>
                        <input type="text" id="lastName" name="lastName" class="form-control">
                        <span id="lnFeedBack" class="help-block"></span>
                    </div>
                    <div id="emailGroup" class="form-group">
                        <label class="control-label">Email:</label>
                        <input type="text" id="email" name="email" class="form-control">
                        <span id="emailFeedBack" class="help-block"></span>
                    </div>
                    <div id="phoneGroup" class="form-group">
                        <label class="control-label">Phone:</label>
                        <input type="text" id="phone" name="phone" class="form-control">
                        <span id="phoneFeedBack" class="help-block"></span>
                    </div>
                    <div id="usernameGroup" class="form-group">
                        <label class="control-label">Username:</label>
                        <input type="text" id="username" name="username" class="form-control">
                        <span id="usernameFeedBack" class="help-block"></span>
                    </div>
                    <div id="pwdGroup" class="form-group">
                        <label class="control-label">Password:</label>
                        <input type="text" id="password" name="password" class="form-control">
                        <span id="pwdFeedBack" class="help-block"></span>
                    </div>
                    <div id="commentGroup" class="form-group">
                        <label class="control-label">Comments:</label>
                        <input type="text" id="comment" name="comments" class="form-control">
                        <span id="commentFeedBack" class="help-block"></span>
                    </div>
